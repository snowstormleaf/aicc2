import { PersonaProfile } from '../lib/llm-client';
...
export const vehicles = {
  'ford-transit-custom': {
    ...
    description: 'Versatile commercial van for business and cargo transport'
  },
  'ford-ranger': {
    brand: 'Ford',
    name: 'Ranger',
    category: 'Pickup Truck',
    description: 'Rugged pickup truck for work and adventure'
  },
  'ford-kuga': {
    brand: 'Ford',
    name: 'Kuga',
    category: 'SUV',
    description: 'Family-friendly SUV with advanced technology'
  },
  'ford-tourneo': {
    brand: 'Ford',
    name: 'Tourneo',
    category: 'People Mover',
    description: 'Spacious people mover for families and groups'
  }
};